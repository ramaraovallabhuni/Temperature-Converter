...
public class TemperatureConverter extends WindowAdapter implements ActionListener
{
	Frame f=new Frame();
	String a="";
	...
	{
		TemperatureConverter f1=new TemperatureConverter();
	}
}